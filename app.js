...
const addedUser = require('./routes/addedUser')
...
app.use('/admin', oidc.ensureAuthenticated(), adminPageRouter)
app.use('/delete', oidc.ensureAuthenticated(), deleteUser)

app.use('/addedUser', oidc.ensureAuthenticated(), addedUser)
